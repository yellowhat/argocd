...
![Version: 1.3.9](https://img.shields.io/badge/Version-1.3.9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2022.12.1](https://img.shields.io/badge/AppVersion-2022.12.1-informational?style=flat-square)
...
**Homepage:** <https://gitlab.com/Yellowhat/mule/-/tree/main/charts/pihole>
...
* <https://gitlab.com/yellowhat/mule/-/tree/main/charts/pihole>
...
| dnscrypt.image.tag                            | string | `"2.1.2"`                                         |                                                                                                   |
...
| monitoring.influxdb.image.repository          | string | `"registry.gitlab.com/yellowhat/pihole2influxdb"` |                                                                                                   |
| monitoring.influxdb.image.tag                 | string | `"v1.2.1"`                                        |                                                                                                   |
...
| monitoring.sidecar.image.tag                  | string | `"v0.3.0"`                                        |                                                                                                   |
